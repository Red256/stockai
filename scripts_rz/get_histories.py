...
from scripts_rz.generate_ticker_list import choose_and_save_my_list
...
def download_histories(intervals=["1m","5m","1d"],
    ...
    ## add existing file list. so that to remove if got new data
    existing_files = [DATA_PATH+'/'+f for f in os.listdir(DATA_PATH)]
    get_new_data = False
